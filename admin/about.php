...
<head>
    ...
    <title>Jungle Resort | Aboutus Counter</title>
                ...
                <div class="col-12">
                    <div class="card mt-3">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h3 class="home_color">Aboutus Counter</h3>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Counter Value</th>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                echo $categories[$row['name']] ?? 'Unknown';
                                                ?>
                                            </td>
                                            <td class="text-center"><?php echo $row['counter_value']; ?></td>
                                            <td class=text-center>
                                                <?php
                                                $status = $row['status'];
                                                $idm = $row['id'];
                                                ...
                                                <button type="button" name="update3" class="btn btn-primary btn-sm m-2"
                                                    onclick="myfcn6(<?php echo $row['id']; ?>, '<?php echo $row['counter_value']; ?>')"
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method='post' enctype="multipart/form-data">
                <div class="modal-body p-4">
                    ...
                    <div class="form-group">
                        <label for="text">Counter Value:</label>
                        <input type="text" class="form-control" id="about_counter" name="counter1">
                    </div>
                </div>
...
if (isset($_POST['banner_update'])) {
    ...
    $sql1 = "UPDATE about_counter SET counter_value='$counter1', update_at='$currentDateTime' WHERE id='$id'";
