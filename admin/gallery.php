                ...
                <div class="col-12">
                    <div class="card mt-3">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h3 class="home_color">Gallery</h3>
                                ...
                                <tbody>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><img src="upload/gallery/<?php echo $row['image']; ?>"
                                            ...
                                            <td class="text-center">
                                                ...
                                                echo $categories[$row['category']] ?? 'Unknown';
                                                ?>
                                            </td>
                                            <td class=text-center>
                                                <?php
                                                ...
                                                <button type="button" name="update3" class="btn btn-primary btn-sm m-2"
                                                    onclick="myfcn4(<?php echo $row['id']; ?>, '<?php echo $row['image']; ?>', '<?php echo $row['category']; ?>')"
                                                    data-toggle="modal" data-target="#updatebanner" title="Edit"
                                                    aria-hidden="true">
                                                    <i class='fas fa-edit'></i>
                                                </button>
                                                <a onclick="confirmDelete(<?php echo $row['id']; ?>, tb='gallery', tbc='id', returnpage='gallery.php');"
                                                    title="Delete">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-white">Gallery</h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-12">
                                <label for="exampleInputcname">Gallery Image:</label>
...
if (isset($_POST['banner_insert'])) {
    ...
    $sql = "INSERT INTO gallery (category, image, status) VALUES ('$category', '$new_file_name', '1')";
            ...
            <form action="<?php $_SERVER['PHP_SELF']; ?>" method='post' enctype="multipart/form-data">
                <div class="modal-body p-4">
                    ...
                    <div class="form-group col-12">
                        ...
                        <img src="#" id="image14" alt="Profile Image" width="50" height="50" class="mt-2 img-fluid">
                    </div>
                    <div class="form-group col-12">
                        <label>Select Category:</label>
                        <select name="category" id="category_gallery" class="form-control" required>
                            <option value="">-- Select Category --</option>
                            <option value="1">Adventure</option>
                            <option value="2">Rooms</option>
                            <option value="3">Foods</option>
...
if (isset($_POST['banner_update'])) {
    ...
    if ($image_name == NULL) {
        ...
        $sql1 = "UPDATE gallery SET category='$category', update_at='$currentDateTime' WHERE id='$id'";
        ...
        $sql_previous_image = "SELECT image FROM gallery WHERE id='$_POST[id4]'";
        ...
        if (move_uploaded_file($image_tmp, $target_file)) {
            ...
            $sql1 = "UPDATE gallery SET category='$category', image='$new_file_name', update_at='$currentDateTime' WHERE id='$id'";
            if ($conn->query($sql1) == true) {
                echo "<script>
                        $(document).ready(function(){
                        toastr.success('Form submitted successfully');
