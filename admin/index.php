                        ...
                        <div class="inner">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    include 'conn.php';
                                    if ($conn) {
                                        $query = "SELECT COUNT(*) as rowCount FROM banner WHERE service_name = ''";
                        ...
                        <tbody>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php echo $row['enquiry_wp_num']; ?>
                                    </td>
                                    <td class="text-center">
                                        <?php echo $row['enquiry_mobile_num']; ?>
                                    </td>
                                    <?php
                                    include 'conn.php';
                                    ...
                                    ?>
                                    <td class="text-center">
                                        <?php echo $row['enquiry_loc']; ?>
                                    </td>
                                    <td class="text-center">
                                        <?php echo $row['date_of_enquiry']; ?>
                                    </td>
                                    <td class="text-center">
