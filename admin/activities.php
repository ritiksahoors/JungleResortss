...
<head>
    ...
    <title>Jungle Resort | Service Activities</title>
                ...
                <div class="col-12">
                    <div class="card mt-3">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h3 class="home_color">Service Activities</h3>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Service Activities Image</th>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><img
                                                    src="upload/activities/<?php echo $row['image']; ?>" alt="profile image"
                                                    width="50" height="50">
                                            </td>
                                            <td class=text-center>
                                                ...
                                                <button type="button" name="update3" class="btn btn-primary btn-sm m-2"
                                                    onclick="myfcn7(<?php echo $row['id']; ?>,'<?php echo $row['image']; ?>')"
                                                    data-toggle="modal" data-target="#updatebanner" title="Edit"
                                                    aria-hidden="true">
                                                    <i class='fas fa-edit'></i>
                                                </button>
                                                <a onclick="confirmDelete(<?php echo $row['id']; ?>, tb='activities', tbc='id', returnpage='activities.php');"
                                                    title="Delete">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title text-white">Service Activities</h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-12">
                                <label for="exampleInputcname">Service Activities Image:</label>
...
if (isset($_POST['banner_insert'])) {
    ...
    $sql = "INSERT INTO activities (image, status) VALUES ('$new_file_name', '1')";
    if ($conn->query($sql) === true) {
        echo "<script>
                $(document).ready(function(){
                    toastr.success('Activities inserted successfully');
                    setTimeout(function(){
                        window.location.href = 'activities.php';
                    }, 2000); // 2000 milliseconds = 2 seconds
                });
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="form-group col-12">
                        ...
                        <input type="file" name="image" class="form-control" placeholder="image"
                            accept=".png, .jpg, .jpeg"
                            onchange="document.getElementById('image118').src = window.URL.createObjectURL(this.files[0])">
                        <img id="image118" src="dist/img/noimage1.png" alt="New image" width="50" height="50" />
                        <img src="#" id="image16" alt="Profile Image" width="50" height="50" class="mt-2 img-fluid">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
...
if (isset($_POST['banner_update'])) {
    ...
    $sql_previous_image = "SELECT image FROM activities WHERE id='$_POST[id7]'";
    ...
    $target_file = $upload_dir . $new_file_name;
    if (move_uploaded_file($image_tmp, $target_file)) {
        $sql1 = "UPDATE activities SET image='$new_file_name', update_at='$currentDateTime' WHERE id='$id'";
